(function() {
    ...
    var LeoView = React.createClass({
        ...
        render: function() {
            var leoImages = _.map(this.state.images, function(imageUrl, i) {
                return (
                    React.createElement("div", {key: i, className: "col-xs-3"}, 
                ...
                React.createElement("div", {className: "container"}, 
                    React.createElement("div", {className: "row"}, 
                        React.createElement("div", {className: "col-xs-10"}, 
                            React.createElement("h1", null, " Leo x ", this.state.images.length, " ")
                        ), 
                        React.createElement("div", {className: "col-xs-2"}, 
                            React.createElement("button", {className: "btn btn-success", onClick: this._addImage}, " Moar Leo"), 
                            React.createElement("button", {className: "btn btn-danger", onClick: this._removeImage}, " Less Leo :(")
                        )
                    ), 
                    React.createElement("div", {className: "row"}, 
                        leoImages
    ...
    // Start the app
    function main() {
        React.render(React.createElement(LeoView, null), document.getElementById("react-container"));
    }
    main();
})();
